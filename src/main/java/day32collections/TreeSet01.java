...
public class TreeSet01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("TreeSet in uygulama suresi :" + (two-one));//TreeSet in uygulama suresi :832125
        System.out.println("HashSet in uygulama suresi :" + (three-two));//HashSet in uygulama suresi :47667

        //Note: TreeSet eleman eklemede cok yavas,HashSet ise cok hizlidir.
        //      TreeSet'in bu negatif yonunden kurtulmak icin HashSet olusturur,elemanlari ekler ve sonra HashSet'i
        //      TreeSet'e ceviririz.
