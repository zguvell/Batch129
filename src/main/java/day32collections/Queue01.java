...
public class Queue01 {
    ...
    /*
       ...
       Data Type'i "Queue" olan bir object olusturmak icin "new" keyword'unden sonra
         i)LinkedList
         ii)Priority Queue Class'lari kullanilabilir.

       "Queue" olustururken constructor olarak "PriorityQueue" kullanirsaniz, elemanlari kendi belirleyeceginiz kurala
        gore siralama hakkiniz olur.
     */
